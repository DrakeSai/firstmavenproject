...
public class ExtentManager extends BasePage {
	...
	public static ExtentReports getReport() {
		if(extentReport == null) {
			setupExtentReport("firstmavenproject");
		}
		return extentReport;
	}
	...
	public static ExtentReports setupExtentReport(String testName) {
		...
		// Directory: "C:\\Users\\FA21617\\Documents\\GitHub\\firstmavenproject\\report\\"
		// System.getProperty("user.dir") + "/report/"
		ExtentSparkReporter spark = new ExtentSparkReporter( "C:\\Users\\FA21617\\Documents\\GitHub\\firstmavenproject\\report\\" +
